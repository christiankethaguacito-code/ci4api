        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-4 text-center text-md-start mb-2 mb-md-0">
                    <i class="fas fa-book-open me-2"></i>Book Library System
                </div>
                <div class="col-md-4 text-center mb-2 mb-md-0">
                    <a href="/api/books" target="_blank" class="text-white me-3" title="API Documentation">
    ...
    <script>
        ...
        function filterByGenre() {
            ...
            for (let i = 1; i < rows.length; i++) {
                const genreCell = rows[i].querySelector('.badge-genre');
                if (!filter || (genreCell && genreCell.textContent.toLowerCase().indexOf(filter) > -1)) {
        ...
        function exportTableToCSV() {
            ...
            downloadLink.download = 'books_export_' + new Date().toISOString().slice(0,10) + '.csv';
