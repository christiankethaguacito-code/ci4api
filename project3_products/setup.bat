@echo off
:: ============================================
:: Product Inventory - Admin Auto Setup
...
echo.
echo ============================================
echo   Product Inventory - Full Auto Setup
...
set "PROJECT_DIR=%~dp0"
set "DB_NAME=product_inventory_db"
set "DB_USER=root"
set "DB_PASS="
...
echo   Or: php spark serve --port 8083
echo.
echo   Visit: http://localhost:8083
echo.
