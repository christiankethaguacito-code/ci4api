        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-4 text-center text-md-start mb-2 mb-md-0">
                    <i class="fas fa-users-cog me-2"></i>HR Employee System
                </div>
                <div class="col-md-4 text-center mb-2 mb-md-0">
                    <a href="/api/employees" target="_blank" class="text-white me-3" title="API Documentation">
    ...
    <script>
        ...
        function exportTableToCSV() {
            ...
            downloadLink.download = 'employees_export_' + new Date().toISOString().slice(0,10) + '.csv';
